...
---------------------------------------------------*/
	...
	function populateBlog() {
		...
		if( $('body.blog-post').find('[data-trigger=fetch-blogs]').length > 0 ) {
			switch($('body.blog-post').find('[data-trigger=fetch-blogs]').data('post-id')) {
				case 1:
